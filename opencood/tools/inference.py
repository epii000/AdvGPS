...
def test_parser():
    ...
    parser.add_argument('--model_dir', type=str,default="/home/jinlongli/2.model_saved/3.Attack_V2V2023/0.attack_model/attfuse_fintune_voxel_2023_07_21_07",# 
...
def main():
        ...
        with torch.no_grad():
            ...
            if opt.fusion_method == 'nofusion':
                ...
                raise NotImplementedError('Only early, late and intermediate'
                                          'fusion is supported.')
            # cur_ratio = output_dict['ego']['ratio']
    ...
    # print('ratio_mean:'+str(ratio_mean))
