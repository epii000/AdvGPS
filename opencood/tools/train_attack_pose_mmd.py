...
def main():
    ...
    def calc_distance(source_pose,attacked_pose,transformation_matrix_1):
        ...
        for i in range(1,num):
            ...
            attacked_cav_in_ego = torch.mm(attack ed_cav_to_word, ego_to_cav)
    ...
    for epoch in range(init_epoch, max(epoches, init_epoch)):
        ...
        for batch_i, batch_data in enumerate(data_loader):
            ...
            for inter in range(num_iter):
                ...
                final_loss = mmdloss(ouput_dict_perfect['before_feature'],ouput_dict_attack['before_feature'])

                #final_loss_2 = mmdloss_2(ouput_dict_perfect['spatial_features'],ouput_dict_attack['spatial_features'])
                ...
                loss_attack = final_loss# + final_loss_2
