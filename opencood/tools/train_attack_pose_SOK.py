    ...
    for epoch in range(init_epoch, max(epoches, init_epoch)):
        ...
        for batch_i, batch_data in enumerate(data_loader):
            ...
            for inter in range(num_iter):
                        ...
                        if Is_learn[index]:
                            ...
                            for i in range(1,add_pose.shape[0]):
                                if not hypes['Attack_params']['random']:####TODO:jinlong
                                    v1.append(torch.tensor([[0.77,0]])) #[step_size[index]
                ...
                final_loss_1 = mseloss(ouput_dict_perfect['psm'],ouput_dict_attack['psm'])
                final_loss_2 = mseloss(ouput_dict_perfect['rm'],ouput_dict_attack['rm'])

                loss_attack  = 0.5 * final_loss_1 + 0.5 * final_loss_2
