...
class VoxelNetIntermediate(nn.Module):
    ...
    def forward(self, data_dict):
        ...
        out_feature_1 = vwfs.clone()   # 2 64 12  208  704
        shape = out_feature_1.shape
        out_feature_1 = out_feature_1.reshape([shape[0],shape[1],shape[2]*shape[3],shape[4]])
        vwfs = self.cml(vwfs)
        out_feature_2 = vwfs   # 2 64 2  208 704
        shape = out_feature_2.shape
        out_feature_2 = out_feature_2.reshape([shape[0],shape[1]*shape[2],shape[3],shape[4]])
        ...
        out_feature_3 = vmfs_fusion  # 1 128 208 704 
