...
class BaseDataset(Dataset):
    ...
    def __init__(self, params, visualize, train=True, isSim=False):
        ...
        if self.train:
            if self.isSim:
                ...
                root_dir = params['root_dir_target']
        else:
            root_dir = params['validate_dir']
        print("loading the dataset: ", root_dir)   
    ...
    def reform_param(self, cav_content, ego_content, timestamp_cur,
        ...
        if cur_ego_pose_flag:
            ...
            # print('11111111111111111111111111', 'delay_cav_lidar_pose', delay_cav_lidar_pose, 'cur_ego_lidar_pose', cur_ego_lidar_pose)
            # print('')
            ...
            spatial_correction_matrix = x1_to_x2(delay_ego_lidar_pose,
                                                 cur_ego_lidar_pose)
            # print('222222222222222222222222222', 'delay_cav_lidar_pose', delay_cav_lidar_pose, 'cur_ego_lidar_pose', cur_ego_lidar_pose)
